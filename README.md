...
**Access the site here** ➜ [PopCorn](https://chaitanyakumars2403.github.io/PopCorn/)
...
1.  Click the **"Start Streaming Now"** button on the Home tab, or navigate directly to the **Browse** tab.
